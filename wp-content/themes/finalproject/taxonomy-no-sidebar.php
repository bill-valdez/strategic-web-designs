	...
	<header role="banner">
		<div class="top-bar clearfix">
			...
			<?php wp_nav_menu( array(
				'theme_location'  => 'main_menu',/*registered in functions*/
				'container' => 'nav', /*wrapped awround the ul*/
			...
			<?php wp_nav_menu( array(
				'theme_location'  => 'utilities',/*registered in functions*/
				'container'       => false, /*wrapped awround the ul*/
				'menu_class'      => 'utilities', /*class of the <ul>*/
				'fallback_cb'     => false,/*if no menu assigned, do nothing*/
			)); ?>
