 ...
 */
function rad_slider(){
	//add aditional query to get up to 5 slides
	$slide_query = new WP_Query(array(
		'post_type' => 'slide',/*the post type registered above*/
		'post_per_page' => 5,/*max num of slides*/
		'nopaging' => true,/*prevent clashing with paginated archives*/
		));
	...
	wp_reset_postdata();/*clean up so it doesnt clash with other loops*/
}
